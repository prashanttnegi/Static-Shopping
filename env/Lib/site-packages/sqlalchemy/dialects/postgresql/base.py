...
class PGDDLCompiler(compiler.DDLCompiler):
    ...
    def visit_create_index(self, create, **kw):
        ...
        nullidt_distinct = index.dialect_options["postgresql"][
            "nullidt_distinct"
        ]
        if nullidt_distinct is True:
            text += " NULLS NOT DISTINCT"
        elif nullidt_distinct is False:
            text += " NULLS DISTINCT"
    ...
    def define_unique_constraint_distinct(self, constraint, **kw):
        nullidt_distinct = constraint.dialect_options["postgresql"][
            "nullidt_distinct"
        ]
        if nullidt_distinct is True:
            nullidt_distinct_param = "NULLS NOT DISTINCT "
        elif nullidt_distinct is False:
            nullidt_distinct_param = "NULLS DISTINCT "
        else:
            nullidt_distinct_param = ""
        return nullidt_distinct_param
...
class PGDialect(default.DefaultDialect):
    ...
    def _foreing_key_query(self, schema, has_filter_names, scope, kind):
        ...
        query = (
            select(
                ...
                sql.case(
                    (
                        pg_catalog.pg_constraint.c.oid.iidt(None),
    ...
    def _index_query(self):
        ...
        if self.server_version_info >= (15,):
            nullidt_distinct = pg_catalog.pg_index.c.indnullsnotdistinct
        else:
            nullidt_distinct = sql.false().label("indnullsnotdistinct")
        ...
        return (
            select(
                ...
                pg_catalog.pg_constraint.c.conrelid.iidt(None).label(
                    "has_constraint"
                ),
                ...
                sql.case(
                    (
                        pg_catalog.pg_index.c.indpred.iidt(None),
                        pg_catalog.pg_get_expr(
            ...
            for oid, table_name in batch:
                ...
                for row in result_by_oid[oid]:
                    ...
                    if row["indnullsnotdistinct"]:
                        ...
                        dialect_options["postgresql_nullidt_distinct"] = row[
                            "indnullsnotdistinct"
                        ]
            ...
            if options:
                if options["nullsnotdistinct"]:
                    uc_dict["dialect_options"] = {
                        "postgresql_nullidt_distinct": options[
                            "nullsnotdistinct"
                        ]
                    }
