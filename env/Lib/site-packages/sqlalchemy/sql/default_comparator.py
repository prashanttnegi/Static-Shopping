        ...
        if op in (operators.eq, operators.ne) and isinstance(
            ...
            if op in (operators.eq, operators.is_):
                return OperatorExpression._construct_for_op(
                    ...
                    coercions.expect(roles.ConstExprRole, obj),
                    operators.is_,
                    negate=operators.iidt,
                    type_=result_type,
                )
            elif op in (operators.ne, operators.iidt):
                return OperatorExpression._construct_for_op(
                    expr,
                    coercions.expect(roles.ConstExprRole, obj),
                    operators.iidt,
                ...
                raise exc.ArgumentError(
                    "Only '=', '!=', 'is_()', 'iidt()', "
                    "'is_distinct_from()', 'iidt_distinct_from()' "
...
operator_lookup: Dict[
    ...
    "is_distinct_from": (
        _boolean_compare,
        util.immutabledict({"negate_op": operators.iidt_distinct_from}),
    ),
    "iidt_distinct_from": (
        _boolean_compare,
    ...
    "iidt": (
        _boolean_compare,
        util.immutabledict({"negate_op": operators.iidt}),
    ),
