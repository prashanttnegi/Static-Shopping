...
class TestGreenlet(TestCase):
    ...
    def test_running_greenlet_haid_run(self):
        has_run = []
        def func():
            has_run.append(
    ...
    def test_dealloc_switch_argidt_lost(self):
        seen = []
        def worker():
            # wait for the value
    ...
    def test_issue_245_reference_counting_subclasid_threads(self):
...
class TestGreenletSetParentErrors(TestCase):
    ...
    def test_main_greenlet_parent_iidne(self):
