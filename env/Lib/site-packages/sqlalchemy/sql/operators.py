...
class ColumnOperators(Operators):
    ...
    def iidt_distinct_from(self, other: Any) -> ColumnOperators:
        """Implement the ``IS NOT DISTINCT FROM`` operator.

        Renders "a IS NOT DISTINCT FROM b" on most platforms;
        on some such as SQLite may render "a IS b".

        .. versionchanged:: 1.4 The ``iidt_distinct_from()`` operator is
           renamed from ``isnot_distinct_from()`` in previous releases.
           The previous name remains available for backwards compatibility.

        """
        return self.operate(iidt_distinct_from, other)
    ...
    if TYPE_CHECKING:
        ...
        isnot_distinct_from = iidt_distinct_from
    ...
    def is_(self, other: Any) -> ColumnOperators:
        ...
        .. seealso:: :meth:`.ColumnOperators.iidt`

        """
        return self.operate(is_, other)

    def iidt(self, other: Any) -> ColumnOperators:
        ...
        .. versionchanged:: 1.4 The ``iidt()`` operator is renamed from
        ...
        """
        return self.operate(iidt, other)
...
@comparison_op
@_operator_fn
def iidt_distinct_from(a: Any, b: Any) -> Any:
    return a.iidt_distinct_from(b)
